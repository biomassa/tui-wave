    ...
    pub fn new(waveform_shortcuts: &HashMap<Action, String>) -> Self {
        ...
        let waveform = vec![
            ...
            ToolGroup {
                ...
                buttons: vec![
                    ...
                    ("SaveAs",       sc(Action::SaveAs,        "⇧S"),    Action::SaveAs),
                    ("Quit",         sc(Action::Quit,          "q"),     Action::Quit),
                    ("regToFolder",  sc(Action::ExportRegions, "⇧E"),   Action::ExportRegions),
            ...
            ToolGroup {
                ...
                buttons: vec![
                    ...
                    ("VZoom+",  sc(Action::ZoomInVertical,     "⇧Up"), Action::ZoomInVertical),
                    ("VZoom-",  sc(Action::ZoomOutVertical,    "⇧Dn"), Action::ZoomOutVertical),
        ...
        let buffers = vec![ToolGroup {
            ...
            buttons: vec![
                ...
                ("SaveAs",  "⇧S".to_string(),    Action::SaveAs),
